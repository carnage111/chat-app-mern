    ...
    return (
      ...
      >
        <Box
          ...
          borderBottomLeftRadius={isSentByCurrentUser ? "20px" : "0px"}
          borderBottomRightRadius={isSentByCurrentUser ? "0px" : "20px"}
        ...
        >
          ...
          {message.content}
          <Text fontSize="8px" color={isSentByCurrentUser ? "#000" : "#0084FF"} fontWeight="800" p="0.3em 0.2em 0.2em 0.0em">
